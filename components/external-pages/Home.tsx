...
export default function Home(){
  ...
  return (
    <div className="min-h-screen bg-background selection:bg-primary/20" ref={targetRef}>
      ...
      <section className="relative overflow-hidden min-h-[100vh] flex items-center justify-center  border-b border-border/40">
        ...
        >
          ...
          >
            ...
            <span className="relative inline-block text-primary/90">
                <span className="absolute -inset-0.5 translate-x-[2px] text-green-500/50 mix-blend-screen blur-[2px]">Bloat.</span>
          ...
          >
            Stop hardcoding tooltips. Build type-safe, component-based product tours that your engineers won't hate maintaining.
          </motion.p>

          <motion.div variants={item} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
             <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-primary to-accent opacity-30 blur-lg group-hover:opacity-50 transition duration-200" />
                <Link href="/signup">
                    <Button size="lg" className="relative h-14 px-8 text-lg rounded-full bg-foreground text-background hover:bg-foreground/90 font-medium">
                    Get Started
                    </Button>
                </Link>
             </div>
             <Link href="/demo">
                <Button size="lg" variant="ghost" className="h-14 px-8 text-lg rounded-full gap-2 hover:bg-primary/80">
      ...
      <section className="relative z-10 py-32 bg-background">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-4xl font-bold tracking-tight mb-4">Native feel, minimal footprint.</h2>
            <p className="text-muted-foreground text-xl">
              Most onboarding tools inject heavy scripts and ugly iframes. We use standard React Portals and 
              framer-motion for 60fps animations that feel built-in.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
               ...
               <div className="relative z-10">
                 ...
                 <h3 className="text-2xl font-bold mb-2">Zero Layout Shift</h3>
                 <p className="text-muted-foreground text-lg">Our engine calculates positioning before painting. No flickering, no jumping UI elements. Just smooth transitions.</p>
               </div>
            </motion.div>
            ...
            >
               ...
               <div>
                 ...
                 <p className="text-muted-foreground">Written in TypeScript. Autocomplete for all props and events right in your IDE.</p>
               </div>
            </motion.div>
            ...
            >
               ...
               <h3 className="text-2xl font-bold mb-2">&lt; 5kb Gzipped</h3>
               <p className="text-muted-foreground">We care about your bundle size. Tree-shakeable and dependency-free core.</p>
            </motion.div>
            ...
            >
               ...
               <p className="text-muted-foreground text-lg">
                 Don't like our UI? Use our <code className="text-primary bg-primary/10 px-1 rounded">useTour</code> hook to build completely custom tooltips while we handle the logic, state, and persistence.
               </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
           <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="flex-1">
                 ...
                 <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">Reads like documentation.</h2>
                 <p className="text-white/60 text-lg mb-8 max-w-md">
                    We designed the API to be intuitive. If you know React, you already know how to use TourGuide.
                 </p>

                 <ul className="space-y-6">
                    {[
                      { title: "Declarative Setup", desc: "Define tours as data or components. Your choice." },
                      { title: "Context Aware", desc: "Tours only trigger when specific conditions are met." },
                      { title: "Event Driven", desc: "Hook into onStart, onComplete, and onStepChange." }
                    ].map((point, i) => (
                      <motion.li 
                        key={i}
                    ...
                    <div className="p-6 font-mono text-sm leading-relaxed space-y-4">
                        <div>
                            <p className="flex gap-2 text-white/90">
                                ...
                                <span>npm install @tourguide/react</span>
                            </p>
                            <p className="text-white/40 mt-2">
                                + @tourguide/react@2.4.0 <br/>
                        ...
                        <div>
                            <p className="flex gap-2 text-white/90">
                                <span className="text-green-500">➜</span>
                                <span className="text-blue-400">~/project</span>
                                <span>vim src/App.tsx</span>
                            </p>
                            <div className="mt-4 p-4 rounded bg-white/5 border-l-2 border-primary">
                                <span className="text-purple-400">import</span> {`{ Tour }`} <span className="text-purple-400">from</span> <span className="text-green-400">'@tourguide/react'</span>;
                                <br/><br/>
                                <span className="text-blue-400">export default</span> <span className="text-yellow-300">function</span> <span className="text-blue-300">App</span>() {`{`}
                                <br/>
                                &nbsp;&nbsp;<span className="text-purple-400">return</span> (
                                <br/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&lt;<span className="text-yellow-300">Tour</span> 
                                <br/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-300">steps</span>={`{steps}`}
                                <br/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-300">theme</span>=<span className="text-green-400">"dark"</span>
                                <br/>
                                &nbsp;&nbsp;&nbsp;&nbsp;/&gt;
                                <br/>
                                &nbsp;&nbsp;);
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold font-display tracking-tight mb-6">
              Ship better onboarding <br />this afternoon.
            </h2>
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
              <Link href="/signup">
               <Button className="h-12 px-8 rounded-full text-base" size="lg">Start Building Free</Button>
              </Link>
                <Link href="/docs">
                  <Button variant="ghost" className="h-12 px-8 rounded-full text-base">Read Documentation</Button>
              </Link>
            </div>
          </motion.div>
        </div>
